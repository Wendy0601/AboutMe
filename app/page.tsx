      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid gap-8 md:grid-cols-[3fr_2fr] md:items-start">
          <div className="space-y-6">
            ...
            <p className="text-xl font-medium text-dark-gray">Research Scientist, Georgia Institute of Technology</p>
            ...
            <div className="rounded-lg bg-muted-teal/5 p-4 shadow-sm">
              ...
              <p className="text-dark-gray">
                My research lies at the intersection of optimization, machine learning, and dynamical systems, with the goal of developing trustworthy AI for power grids and other safety-critical infrastructures. I design methods that improve AI robustness, reliability, and accountability through physics-informed architectures, robust training with formal verification, and safe agentic AI systems capable of self-improvement. Although these methods are primarily motivated by the operational needs of power grids, the underlying algorithms and theoretical principles extend naturally to a broad range of complex engineering systems. My current research vision is to enable the deployment of reliable AI in real-world environments with rigorous, quantifiable, and certifiable trust guarantees.
              </p>
            </div>
            ...
            <div className="pt-2">
              ...
              <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  ...
                  <span>Safe and Responsible Agentic AI</span>
                </li>
                <li className="flex items-center rounded-md bg-gray-50 px-3 py-2 text-dark-gray shadow-sm">
                  <ShieldCheck className="mr-2 h-5 w-5 text-academic-blue" />
                ...
                <li className="flex items-center rounded-md bg-gray-50 px-3 py-2 text-dark-gray shadow-sm">
                  ...
                  <span>Neural Network Verification & Robust Training</span>
                </li>
                <li className="flex items-center rounded-md bg-gray-50 px-3 py-2 text-dark-gray shadow-sm">
          ...
          <div className="mx-auto flex flex-col space-y-4 md:mx-0">
            ...
            <div className="rounded-lg bg-academic-blue/5 p-4 shadow-sm">
              <p className="text-lg leading-relaxed text-dark-gray">
                I am a research scientist specializing in AI, safe agentic AI, trustworthy machine learning, and cyber-physical systems.
